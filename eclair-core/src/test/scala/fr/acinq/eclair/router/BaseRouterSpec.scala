...
abstract class BaseRouterSpec extends TestkitBaseClass {
  ...
  val ann_a = makeNodeAnnouncement(priv_a, "node-A", Color(15, 10, -70), Nil, features = "")
  val ann_b = makeNodeAnnouncement(priv_b, "node-B", Color(50, 99, -80), Nil, features = "")
  val ann_c = makeNodeAnnouncement(priv_c, "node-C", Color(123, 100, -40), Nil, features = "")
  val ann_d = makeNodeAnnouncement(priv_d, "node-D", Color(-120, -20, 60), Nil, features = "")
  val ann_e = makeNodeAnnouncement(priv_e, "node-E", Color(-50, 0, 10), Nil, features = "")
  val ann_f = makeNodeAnnouncement(priv_f, "node-F", Color(30, 10, -50), Nil, features = "")
